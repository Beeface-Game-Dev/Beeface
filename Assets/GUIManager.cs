...
public class GUIManager : MonoBehaviour {
    ...
    void Update()
    {
        ...
        //Sets the Tool Tip Animator's "isVisible" bool based on the Tool Tip's visibility\
            ...
            {
                toolTipAnim.SetBool("isVisible", true);//false
            }
            else
            {
                toolTipAnim.SetBool("isVisible", false); //true
            }
        ...
        if (primary)
        {
            ...
            patkDisp.text = "Resource: " + primary.Resourcecarried; //Displays the unit's physical attack
            pdefDisp.text = "PDEF: " + primary.pdef; //Displays the unit's physical defense
            eatkDisp.text = "PATK: " + primary.patk; //Displays the unit's energy attack
            edefDisp.text = "EDEF: " + primary.edef; //Displays the unit's energy defense
            rankDisp.text = "" + primary.rank; //Displays the unit's rank
            killDisp.text = "EATK: " + primary.eatk; //Displays the unit's kill count

            if(nameDisp.text == "Queen beeface")//||nameDisp.text == "Beeface")
            {
            ...
            {
                Buttonspawn.gameObject.SetActive(false);
